...
%Anna: Evt henvise tilbage til kapitel 1
...
\begin{itemize}
	...
	%Anna: Tænker ikke at linjen ovenoer i virkeligheden har noget med den første sætning at lave. Kan vi evt slette den?
	\item
...
%Anna: Ved godt vi ikke skal markerer formuleringer men tænker, den her skal have en tur, da space required to store kun er for dem der har det digitalt (analogt fylderdet jo ret meget), men hvis ligegyldigt bare slet denne kommentar

Ipsen works together with the firm to make sure that their handbooks are in good shape for audit.
%on behalf of sekretærens rolle er mindre relevant i dette afsnit, uddybes senere og det der staar her er direkte forkert vil jeg gerne slette nedenstende linje -Astrid
...
%Anna: Samme kommentar som før read status, var som udgangspunkt ikke en ting før Rasmus fremlagde det til første interview
...
%Anna: i introen er strukturen allerede gennemgået så synes ikke denne line (nedenfor) passer ind i sammenhængen
