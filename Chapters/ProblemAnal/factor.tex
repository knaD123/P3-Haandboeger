...
%Anna: Det med at opretholde ISO-standarderne skal vi nok enten hurtigt afgrænse os væk fra eller gøre mere ud af, (for at hvis vejleder i princippet læste op på det skulle vi kunne gå i dybden og fortælle om hvordan vi opfylder og evt ikke opfylder kravene)
...
\todo{Anna: Har omskrevet lidt på sidste sætning. Derudover kunne det give mening at præsenterer Rich picture først og derefter FACTOR og så slutte af med den endelige system defn?}
...
\todo[inline]{skal der noteres noget om typen af server vi bruger eller er det ikke nødvendigt her (tænker ikke det er nødvendigt, men vil lige være sikker)}
...
%\todo[inline]{Skal vi have et seperart afsnit hvro selve system definitionen skrives ud på baggrund af FACTOR?????} Anja siger ja til spørgmsålet.
