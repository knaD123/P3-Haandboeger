...
\todo[inline]{Anna: Har prøvet at tilføje dette efter at have skrevet med dig Astrid, er det her fint nok eller hvad tænker du?}
\paragraph{Compared to now}these two systems are close to how the work is done already except for the feature of sharing files, which is also why it is good to reflect upon them.
Though it has become clear through the first interview with Ipsen and the research into the official government requirements, that the systems lack better and easier management of different versions and documents, as well as a more specific access permissions.
