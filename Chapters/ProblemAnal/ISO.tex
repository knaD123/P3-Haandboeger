...
\subsection{ISO}
% So ISO 9001 should be moved down here? Anja: Ja
% Again, very sales-speech like - Rasmus
% Anja: Jeg er uenig med Rasmus. Teksten nedenfor er en fin introduktion. Det skal også flyttes længere op.
...
% Anja: Jeg mangler en god argumentation for, hvorfor ISO-standarderne er relevante at medtage i problemanalysen. Hvordan er standarderne relevante for os? Hvordan er de relevante til at forklare problemområdet, eller hvordan er de relevante, når vi skal udforme systemet. Hvis vi ikke kan argumentere for, hvorfor standarderne er relevante, så bør vi nok cutte sektionen fuldstændig.
