...
%Anna: Kna man argumenterer for at den definition skal have en anden kilde da DEB bogenciterer en anden kilde der
...
%Anna: istedet for 'it is a good idea' nærmere bruge 'it is essential'
...
%Anna: Evt tilføje "This may happen when the user interacts with the system during tests and it becomes clear misunderstandings of the basic concept has happend. Furthermore, it mayu also happen when the user realises other need's than what was thought necessary of the system to begin with"
