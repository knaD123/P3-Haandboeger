...
%virker lidt underligt at vi introducerer begreberne men aldrig bruger dem - astrid
...
.
%vil vove at paastaa at sidste halvdel af sætning ovenover allerede er dækket med sætning over det
...
%flyttede lige henvisningen - virkede en anelse clunky midt i sætningen - astrid
...
%generelt ville det være smukt hvis alle formuleringerne startede med must have [krav]. altsaa must have a tool to manage versions i stedet for must have: the system must manage ... Ved dog ikke om det er noget vi gider at bruge tid paa saa sent i processen
\begin{itemize}
    \item
    Must have:
        \begin{itemize}
        ...
        \end{itemize}
    \item
%ændrede must til should ovenover
    Should have:
        \begin{itemize}
    ...
    Could have:
        \begin{itemize}
			...
			\todo[inline]{(Tanke):skal evt diskuteres et sed at ideen er at alle associated får notificatione i systemet og dem med enten mail eller mobil vil yderligere får notifikation den vej rundt}
            \item
        ...
        \end{itemize}
%ændret should til could ovenover - astrid
    \item
    Want to have but Won't have this time around:
        ...
        \end{itemize}
\end{itemize}
\todo[inline]{Vi skal have tilføjet herinde i det rigtige niveau, at systemet skal kunne opdaterer sidehoveder på uploadede filer med hvem der godkender dato og versionsnummer (Ogås når den ikke længere er gældende)}
...
%er must have ikke bare helt generelt MVP? jeg troede det var selve definitionen? - astrid
