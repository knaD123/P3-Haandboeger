...
%Anja: Jeg er enig, which conditions?
%astrid: factor. tilføjet
...
%ganske udemærket ide der hidtil ikke er blevet overvejet. in honor of vi har ikke tid synes jeg dog at vi skal lade være - astrid
...
%Anja: Jeg er enig med Anna, what is this about efficient being easily fulfilled? Denne paragraf har brug for et helt nyt argument.
...
%slettet nogle ord der forbentlig har gjort sætningen mere læselig og korrekt - astrid
...
% ?????? ikke sikker  at jeg forstaar din argumentation her??? hvis brugerne mister tillid mister de nogle penge. hvis de lige pludselig er i modstrid med loven risikerer de a) en voldsom bøde eller b) helt at blive lukket og c)  mister de under alle omstændigheder brugernes tillid hvis de havner i retten - astrid
...
%Anja: Dette er noget iffy argumentation.
...
The system is however already developed with the future in mind: The changelog, which Ipsen has requested, is not a requirement under the current conditions, however it is a change which she assumes will happen within the next ten years or so, as stated in \cref{sec:CaseDescription}.
...
%men valg er allerede forklaret i klasssediagram? - astrid
...
%det er i hvert fald en god pointe at enten er det en tekonlogi ift. factor og saa skal det med her eller ogsaa skal det ikke nævnes nogen af stederne
