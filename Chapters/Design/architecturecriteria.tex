...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Prioritized list of criteria}\label{fig:criteria}
\end{table}
...
In this context, \textbf{efficient} refers to the speed of the software. As all the operations in the application are quite simple, and no advanced custom algorithms have to be designed, see \cref{sec:functions}, they will not take much processor time.
