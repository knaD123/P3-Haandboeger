\subsection{Components} \label{archicomponents}
In this section the component design will be elaborated.
It has been decided that the system is going to be implemented to the internet which is why the ASP.NET Core framework has been chosen for implementation.
In the following the ASP.NET Core framework will be explored alongside the MVC Design pattern, Entity Framework, web fronts and the database design.

\subsubsection{Component design theory}
