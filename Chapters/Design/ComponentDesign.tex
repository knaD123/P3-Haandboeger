...
In relation to the ASP.NET MVC pattern there are immediate similarities to the component design theory in {\color{red}\cref{archicomponents}}.
...
In relation to the theory written in {\color{red}\cref{archicomponents}} the components can be designed in layers to describe their responsibilities and relation to each other.
