...
The framework has built-in support for many common features, such as database integration, identity and authorization with multi-factor, external auth and CSS frameworks.
%Anna: auth er det ikke authentication der menes?
...
Originally meant for GUI development, the pattern has been adapted into web development, and is used by many of the frameworks in the space. \cite{gangoffour}
...
\end{figure}
\todo[inline]{Anna: Hvis tid en aften, prettify}
