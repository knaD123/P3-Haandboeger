...
\centering
	...
	\end{tikzpicture}
	\caption{The MVC design pattern.}\label{fig:MVC-components}
\end{figure}
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{The relationship between ASP.NET Core and the relational database, with EF Core acting as glue between the two layers}\label{fig:ASP-Entity}
\end{figure}
