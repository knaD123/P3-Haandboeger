...
% Henrik: Enig med Anna, men der bliver vist nævnt noget med TDD senere i rapporten
...
\end{figure}
% Henrik: Jeg er maaske ikke helt enig i pilen mellem Model og View, da alt data leveret til Viewet gaar gennem Controller - Maaske jeg bare misforstaar tegningen :-)
...
% Henrik: SQL bliver nævnt i database afsnittet
\begin{figure}[H]
	\centering
...
% Henrik: Synes det er relevant, da det fortæller at vi ikke er laast fast til én bestemt database
...
% Henrik: HTML, CSS og JavaScript (jQuery) er de eneste vi har brugt
...
% Henrik: Det hedder document - maaske DOM (Document Object Model), men kan være at jeg blander document og DOM sammen :-)
...
% Henrik: Eventuelt brug det JavaScript der er brugt til at ændre pilenes retning (Den nyeste PR)? :-)
