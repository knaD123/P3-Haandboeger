...
\todo[inline]{Rasmus: hvorfor er log ikke en klasse og hvorfor er det smart}
...
%Anna: Hører den her i virkeligheden ikke til qualified classes?
...
Looking at the event table below it can be seen that \textit{document added} and \textit{document deleted} both can occur zero or multiple times for \textit{Handbook} and zero or one time for \textit{Document}.
...
\end{table}
\todo[inline]{Henrik fiks det så vi ikke bliver grillet til eksamen}
