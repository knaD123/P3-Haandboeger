...
% marker events med fed

\begin{itemize}
	\item Notification sent % Henrik: Måske "Notification sent"?
	...
	\item Document reactivated % det er vel document  archived
	...
	\item Subscribed to documents % bliver til add/ remove user
