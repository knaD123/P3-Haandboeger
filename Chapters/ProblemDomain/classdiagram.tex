...
\todo[inline]{Store bogstaver for klasser}
...
\todo[inline]{Anna: Tilføj den rigtige reference}
\begin{figure}[H]
	\centering
...
\todo[inline]{Henrik: Omformuler saa den her paragraf er nemmere at følge med i}
...
\end{figure}
\todo[inline]{Anna: Lav abstrakte klasser dotted underlined og textit}
