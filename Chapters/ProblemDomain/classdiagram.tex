...
\todo[inline]{Anna. fix klassediagram}
...
% Tidligere formulering: In the supplier-approval system a supplier needs to be approved and only one person is needed to do that.
