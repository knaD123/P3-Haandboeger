...
%Anna: Jeg vidste ikke hvpr du ville have den henne men her
\begin{figure}[H]
	\centering
	\includegraphics[width=0.60\textwidth]{billeder/RP-Roller.jpg}
...
\end{figure}
%Anna: Husk at sætte en anden tekst på label end den fra PACT
...
\begin{figure}[H]
	...
	\label{fig:PACT-SystemImage}
\end{figure}
%Anna: Husk sætte en anden label end den fra PACT
