...
The current version of the class diagram in \cref{fig:ClassDiagram} a generalization is used to have their shared functionality included in the abstract class Approval and the more specific functionlities in the subclasses HandbookApproval and SupplierApproval.
