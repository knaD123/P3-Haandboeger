...
\subsection{User}
There are three different types of users which has been modeled by using a role pattern. This gives the system a more dynamic way to handle different contexts.
