...
% Astrid: Jeg tænker det ser lidt spøjst ud at referere til den samme kilde så mange gange. Kunne man evt. gøre ligesom oppe i existing solutions og sige baseret på [indsæt bogens navn her] i selve brødteksten eller sætte sidetal på henvisningerne?

\section{PACT analysis}\label{sec:PACT}
The theory of this section is based upon \cite{Benyon} unless anything else is stated.
%Anna: Har lige tilføjet linjen ovenfor og udkommenteret samtlige steder hvor benyon er citeret
...
%Anna Hvad tænker i om følgende tekst at tilføje:
...
%Anna: Vil vove i hvert fald at påstå human-centered er beskrevet i introen, i første linje, ellers de den udkommenterede forslag ovenfor
...
% Taniya: vi nævner psychological her, men ingen andre steder
% Astrid: jeg byttede lige rundt på rækkefølgen af afsnittene så det matcher med den rækkefølger emnerne bliver præsenteret i.
...
%Astrid: prøvet at omformulere, oprindelig sætning nedenunder
...
%Anna: Kan nu egetngligt selv godt lide den anden formulering for at få frem det ikke athave erfaring er man som regel også påpasselig.
...
%Anna: Ikke rigtigt hvis de var experter ville der jo ikek være brug for en quality manager
...
% astrid: prøvet omformulering. Mit issue var at other eye handicaps virkede meget vagt når vi lige havde været så specifikke som colorblindness.
...
%Anna: Den er jeg ikke sikker på jeg er enig i
...
%jeg tror ikke helt jeg forstår pointen her. når de er færdige med at overveje?

%Anna: Ikke sikker på hvorfor det her afsnit overhovedet er havnet heroppe
...
%jeg tænker at ovenstående nok skal omformuleres men kan ikke komme på noget lige pt. vil gerne tage den dog -astrid
%Anna: 
The secretary and quality manager have a more administrative role.
%, where the quality manager in part writes and maintains the handbook.
...
%kunne man ikke argumentere for at ovenstående pointe allerede er godt hamret ind på dette her tidspunkt?
Whereas the workers ''only'' has to read certain documents.

%Astrid: Måske en "introduktion" til de forskellige aspekter? kunne også være supersmukt med en klarere opdeling (farver måske?) mellem teori og analyse men det er petitesserytteri
...
%ovenstående afsnit trænger vist til en opdatering -astrid
...
%når vi snakker everyday workers mener vi dem i produktionen ikke sandt? er det så dramatisk forskelligt?
...
%Anna: Omskrev ovenfor som erstatning til
%... the implementation of this project
the most common way that the handbooks were used by employees were in printed out form, which allowed the use of the documents in circumstances not conductive to electronic equipment. %Or rather, too conductive. Get it? brilliant joke yes but we kinda expect them to continue using this system?
