...
%burde kilden ikke sættes ind lige omkring her?
%Anna: Lu snakkede om at vil have kilden første gang metoden nævnes og det skre i introen
...
%tænker generelt at teorisektionerne godt kunne være noget mere kompakte men ikke sikker paa om vi har tid ti det - astrid
...
%Anna hvilke andre handicaps kunne vi snakke om i det her specifikke tilfælde (bliver vi garanteret spurgt om til eksamen hvis vi ikke noterer det)
...
%vi har i systemdefinitionen skrevet at de skal have en mail eller sms - det stemmer ikke helt overens med kun at have dem tilgængelige i browser - astrid
...
%Er det rigtigt brug af documents vs versions - Anna
%in context of den definition der bev smidt i iso ja - astrid
...
%Anna: Vil bare noterer det er godt vi får det frem her
...
%omformulering ovenover og tilføjet sætning - astrid
...
%vil vove at paastaa at det her er direkte forkert. forslag: bare slet
There is the CEO, who from time to time reads, %writes, 
and approves the handbook documents.
%Anna secifikt for den her case med JBJ så skriver han ikke dokumenter
...
There are actors within the firm
%, the CEO for example,
who occasionally need to write/update documents in the handbook and need writer access rights.
%Anna: Igen lige i denne case vil jeg påstå det er department heads vi vil bruge og ikke CEO
%er dog ikke sikker  at jbj er stor nok til overhovedet at have department heads som saadaan?? - astrid
...
%Anna er det ikke forkert reference, skal der ikke bare henvises til people analysen?
