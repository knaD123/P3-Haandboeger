...
\todo[inline]{Er det dokumentet brugerne til sat som approver til, eller er det den nye version?}
...
%Anna: "there is a fork", den sætning forvirrer mig
...
%Anna: hendes system var ikke complicated men high maintance
...
%Anja: Jeg synes, det er et forking smukt state-chart! Tjah. Det er de andre ogsaa, men specielt det her!
...
This means that there is a timeframe in which anyone could access the archive with only a username. % Henrik: Jeg er maaske ikke helt enig i det med "timeframe"
Therefore, this workflow assumes that the user will activate their account immediately after getting it. % Henrik: Same thing here
...
\todo[inline]{De har vel adgang til det, de kan bare ikke ændre det?}
...
% Henrik: Skulle der have staaet "... none of the administrators have any ..."?
