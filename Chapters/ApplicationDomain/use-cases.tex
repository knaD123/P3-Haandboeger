...
During the first usability test, see {\color{red}\cref{labellist}}, this workflow was a source for confusion and therefore it was changed.
...
Other ways to handle this is discussed further in {\color{red}\cref{RememberToEditThisInUseCasesToo}}.
...
The design in {\color{red}\cref{design}} explains how the functionality is designed to best support these use cases.
