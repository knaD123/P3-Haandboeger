...
They typically do not have administrative rights and do not write or update the documents within the handbook.
...
There are active and inactive versions, where the active versions are the newest versions of each document, and inactive ones are archived. 
