...
%anything else is not stated. unnecessary - astrid
...
%This is because that update functions should express the system's classes and events.
%der er noget helt galt med denne her sætning -astrid
...
% De andre typer kommer fra use cases - side 143 i SU bogen
