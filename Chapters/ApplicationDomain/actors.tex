...
%Anna: Er det virkeligt en korrekt påstand vil mene at det ikke er det vi har fra Pia, men nærmere en ting som hun siger kan henne
...
\begin{table}[H]
	\begin{tabular}{l p{11.3cm}}
		...
		%Anna: Tænker umiddelbart den sidste sæstnign ikke er nødvendig at tilføje
		&  \\
		...
		%Anna: Tænker sætningen lige ovenfor kunne være fin at slette
		...
		%Anna: Synes også denne sætnign bliver for meget graven i det samme hul så bare slet den
		&  \\
...
%Anna: Hvad menes med update to the handbook (for hvis der menes upload er det kun writer og admin)
...
%Anna: Synes det sidste afsnit her er kringlet skrevet og er ikke sikker på hvad der egentligt menes med det (prøver at blive sagt med det)