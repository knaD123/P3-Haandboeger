...
%Anna: vil gerne have slået de to afsnit sammen
...
\begin{table}[H]
	...
	\begin{tabular}{l p{11.3cm}}
		...
		%Anna: ved godt det er det vi desginer for men er det ikke lidt af en antagelse at skrive allerede her?
		...
		%Anna: kan vi snige ordet "may " ind i sætningen for at tydeliggøre det ikke r noget de nødvendigvis har
		\hline
	\end{tabular}
...
\end{table}
%Anna: Hvis CEo er i admin skal han vel også være repræsenteret i de to andre tabeller
...
\begin{table}[H]
	...
	\begin{tabular}{l p{11.3cm}}
		...
		%Anna: vil mene det er admin og writer han er grundet formalities
		\hline
	\end{tabular}
