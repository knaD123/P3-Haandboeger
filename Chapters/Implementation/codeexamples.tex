...
Likewise, the \texttt{Range} attribute specifies that the section number is included in a an \texttt{Enumerable} class consisting of integers from 1 to the max value of a 32 bit \texttt{Integer}. % Henrik: Jeg har ændret "infinity"
...
% Henrik: HttpGet modtager ikke noget fra controlleren - se kommentar længere oppe
% Henrik: HttpPost ensures ikke at data er submitted
