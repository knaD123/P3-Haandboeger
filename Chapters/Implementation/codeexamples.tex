...
%Anna: har omformuleret det lidt igen.
...
%section number, (Anna har udkommenteret det her antog det var en fejl)
...
The selection control sequence from line 9 - 12 ensures that the previous version's ValidUntilDate is set to the current date.
...
% Anja: Du er ikke den eneste. Jeg forstaar det heller ikke.
...
% Anja: Tjah, det gør jeg heller ikke xD
...
% Anja: Jeg synes, at det vil virke underligt
