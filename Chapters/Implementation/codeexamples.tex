%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GENERELT: Synes dette kapitel skal gennemgaaes GRUNDIGT sammen, da det virker til at der er en DEL forvirring
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Henrik: Tvivlsspørgsmaal - er model, view, controller med lille eller stort?
...
% Andreas: Jeg synes der skal stå listing, ligesom der gøre under kode eksemplet fx Listing 7.1
\\
...
% Henrik: Tvivlsspørgsmaal, igen - bør vi maaske skrive navne paa properties som de staar i koden? :-)
...
% Henrik: Mener faktisk at Task ALTID er async - men kan tage fejl :-)
