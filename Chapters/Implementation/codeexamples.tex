...
This \texttt{display} attribute is used with ASP.NET Core and is used to modify the text on the screen when information from the controller is transfered to the view.
% Henrik: Det er ikke selve controlleren der bliver rendered
% Anja: Har omformuleret.
...
In the code snippet below it is shown what happens when the user adds a new document or version to the system through the \texttt{Add} method.
