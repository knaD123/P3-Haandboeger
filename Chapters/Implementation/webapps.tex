...
% Anja: Samme type kommentar som før: Vi skal liste alle andre mulige metoder/platforme der kunne anvendes til at udforme systemet. Der skal gives et godt argument for, hvorfor lige specielt NixOps bliver udvalgt.
%Anna: er ret sikker på "CM" ikke er blevet brugt som forkortelse før
