...
% Henrik: Ikke sikker paa hvad der staar her? :-)
...
\begin{itemize}
	...
	% Henrik: Tjaaa.. Det her virker ikke rigtig, saa...?
    \item
	...
	% Henrik: What?
	% Henrik: Jeg kan heller ikke se dette punkt i listen af req.
\end{itemize}
...
% Henrik: Det ville ikke være nødvendigt at lave vores egen algoritme, da disse allerede eksisterer
...
%Taniya: hvad er de extra features? 
% Henrik: Tænker lidt, om de ting vi nævner i lister overfor ikke skal være identisk til requirements, nævnt i MoSCoW?
