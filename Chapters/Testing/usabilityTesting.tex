...
Therefore the first usability test only tested the administrator role part of the application.
...
The identified issues discovered during the usability test will be presented and categorized below in \Cref{tab:utest1} with explanations following. 
...
This created confusion which cause an interrupted workflow with the handbook.
...
In the debriefing session Ipsen mentioned that she was surprised that the application required user to attach a pdf file as she has seen other document version control system has their own file editor.
