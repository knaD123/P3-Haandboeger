%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Godt afsnit/kapitel, Taniya! :-D
%
% GENERELT: Lidt med grammatik :-)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
	...
	\item 
	Cosmetic: When the test subject spends few minutes on completing a task and the issue is still not solved. % Anja: Jeg synes, at sætningen er forkert? Hvad skal der staa? Henrik: ændrede "need to" til "not"
\end{itemize}
...
% Henrik: Har tilføjet en cref til HTML og CSS
...
%Anna: kunne det argumenteres at Hun ikke bev testet i se cases på givne tidspunkt da funktionalitet ikke var der, men det mere var en diskussion om design og requirements den blev brugt til at bekræfte?
%Anna(fortsat) hvis ja til kommentaren ovenfor skal listen nedenfor ændres eller fjernes
...
%Anna: kan det give menign at refererer det specifikke billede?
...
% Henrik: Jeg er lidt usikker paa starten af denne sætning
%Anna: Jeg er enig med Henrik, er ikke selv sikker på hvad der menes
...
Ipsen invalidated this functionality, since the reader should not relate it and there was no need for that. % Henrik: "relate it"? :-)
The readers typically had a slightly reading skill.
 % Anja: Hvad skal der staa her?
...
%Anja: Denne sætning er en smule uforstaaelig
...
%Anna: evt bare sige for at åbne bedre op for muligheden for videre udvikling i stedet for?
...
\end{table}
%Anna: kunne det give mening ved de enkelte gennemgange at henvise til de relevante views i appendix?
...
%Anja: Lidt kringlet formulering
% Henrik: Anja, hjalp det med et par kommaer? :-)
...
% Henrik: Jeg er ikke helt med paa starten af denne sætning :-)
...
%Anna: der skal tjekkes op på, de bilelder som allerede er i appendiks skal i stedet refereres fremfor at sættes ind her. mens resten godt må bliv
...
%Anna: udkommenterede den da jeg er ueing
...
New functionalities had been added, which was the option to both upload pdf file and a working file (excel, word etc.), see \Cref{fig:WorkingFile}.
%Anna: ligger de billeder ikke i appendiks i så fald skal de nok ikke være heroppe?
...
%Anna: hvorfor er de to udkommenteret?
% Henrik: Usikker paa om Astrid guidede ham her, saa maaske ikke et godt eksempel? :-)
...
%Anna: tilgængæld kan vi ikke slette linjen ovenfor?
...
%Anna: Kan evt argumenterer for at vi ikke nødvendigvis behøves skrive det her, men det er en ting vi ved og kan forsvarer hvis de sprøg (bare en tanke)
...
%Anna: vil gerne fjerne nederste linje
...
%Anna: evt henvise tilbage til iteration 4 med den her (specifict under things to take notice of)
...
% Ved ikke om det burde nævnes? - Anna: tænker godt vi kan tillade os at lade være med alle de andre ting vi pointerer
