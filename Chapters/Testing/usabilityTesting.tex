...
%hedder det topbar? - Nej det er jeg ret sikker på det ikk egør (Anna)

The identified issue '2' appeared when Ipsen attempted to upload a new version to the handbook.
New functionalities had been added which was the option to both upload pdf file and working file (excel, word etc.), see \Cref{fig:WorkingFile}.
