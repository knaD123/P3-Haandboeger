...
The project group has, throughout this project, used GitGub \footnote{GitHub is a hosting platform for version control using Git} to perform peer reviews before merging new code into the project. % Henrik: "into the project" skal nok omformuleres
