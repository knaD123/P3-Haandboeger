...
Static white-box tests are performed without running the software, but in contrary to black-box tests, the tester has access to the code. % Henrik: Hvordan, hvis nødvendigt, henviser jeg til baade defn og black-box?
...
% Henrik: Indsæt fodnote der fortæller hvad GitHub er
The project group has, throughout this project, used GitGub to perform peer reviews before merging new code into the project. % Henrik: "into the project" skal nok omformuleres
