...
During this activity the data gathered at the interview was reevaluated and used to update the relevant models and analysis' such as the FACTOR model and the class diagram, see \cref{factor,sec:classdiagram}.
% Henrik: Er det de rigtig cref jeg har skrevet?
...
Since Ipsen had changed her decision upon how the archive should work.
 During the, short, second interview in iteration 1, it was said that the date search function in the archive would be obsolete.
...
% Henrik: Cref til den rigtige prototype - kan dog ikke huske hvilken
...
These are mentioned in the FACTOR analysis in \cref{factor}.
...
% Henrik: Hvad sker der lige i den her sætning? else.'',?
