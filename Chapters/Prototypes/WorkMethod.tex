...
% Henrik: Maaske henvis til "5.1.2.1 Defining requirements"?
...
% Henrik: Maaske henvis ned til "Bug" afsnittet?
...
%Therefore, ''Most projects start with establishing requirements'' \citep[p.~333]{InteractionDesign}. 
%%It is from this first activity that it’s possible to go into the designing process.
...
% Henrik: Efter waterfall, masske henvis til waterfall afsnittet
