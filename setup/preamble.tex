...
% Anvend : \thickhline
\usepackage{tabulary}
\usepackage{graphicx, subcaption} 						% Haandtering af eksterne billeder (JPG, PNG, EPS, PDF)
\usepackage{wrapfig}
...
\tikzstyle{predefined} = [rectangle, rounded corners, thick, minimum width=1cm, minimum height=0.75cm, text centered, %text width=3cm,
...
\newmdtheoremenv[style=box,linecolor=theoline,backgroundcolor=lemcolor]{defn}{Definition}[section]
...
\makeevenhead{AAU}{Gruppe: DAT3 ds304e19}{}{\leftmark}				% Definerer lige siders sidehoved (\makeevenhead{Navn}{Venstre}{Center}{Hoejre})
