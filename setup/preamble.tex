...
\newmdtheoremenv[style=box,linecolor=theoline,backgroundcolor=theocolor]{theorem}{Sætning}[section]
...
\newmdtheoremenv[style=box,linecolor=theoline,backgroundcolor=lemcolor]{corollary}[theorem]{Korollar}
...
\renewenvironment{proof}[1][Bevis]{\begin{trivlist}
\item[\hskip \labelsep {\bfseries #1}]}{\end{trivlist}}

\newenvironment{definition}[1][Definition]{\begin{trivlist}
\item[\hskip \labelsep {\bfseries #1}]}{\end{trivlist}}

\newenvironment{remark}[1][Bemærkning]{\begin{trivlist}
\item[\hskip \labelsep {\bfseries #1}]}{\end{trivlist}}
...
\newtheorem{eks}[theorem]{Eksempel}
...
\newenvironment{example}[1][Eksempel]{\begin{trivlist}
\item[\hskip \labelsep {\bfseries #1}]}{\end{trivlist}}
\surroundwithmdframed[
   topline=false,
   rightline=false,
...
\addto\captionsdanish{\renewcommand{\figurename}{Figur}} %Aendre figurteksten til dansk
...
% Skriver "Kapitel" foran kapitlerne i indholdsfortegnelsen
	\renewcommand\cftappendixname{Appendiks ~}
...
\usepackage{cleveref}
    ...
    \Crefname{appendix}{Appendiks}{Appendikser}
    \crefname{eks}{eksempel}{eksempler}
    \Crefname{eks}{Eksempel}{Eksempler}
